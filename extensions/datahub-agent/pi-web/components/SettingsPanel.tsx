  ...
  return (
    <div className="settings-general">
      ...
      <section className="settings-general-section">
        ...
        {DATAHUB_EMBED ? (
          <p>
            DataHub theme · Deployment controlled. Standalone appearance
        ...
        {DATAHUB_EMBED && (
          <p className="datahub-attribution">
            Based on pi-web {process.env.NEXT_PUBLIC_APP_VERSION ?? "0.9.0"} ·
            MIT
          </p>
        )}
      </section>
      ...
      {DATAHUB_EMBED && <p>Sign out from DataHub to end your Agent access.</p>}
      {webAuthEnabled && !DATAHUB_EMBED && (
        <section className="settings-general-section">
          <ConfigButton
            variant="secondary"
            disabled={loggingOut}
...
export function SettingsPanel({
  ...
  const sections: {
    ...
    { id: "mcp", label: "MCP", requiresProject: false },
  ...
  useLayoutEffect(() => {
    ...
    // Restore before React removes the focused panel from the document.
    return () => {
    ...
    >
      <div className="settings-dialog-surface">
        ...
        <main className="settings-dialog-main">
          ...
          {sectionHost(
            "mcp",
            <McpConfig sessionId={sessionId} onReloaded={onSessionReloaded} />,
          )}
          {cwd &&
            sectionHost(
              "skills",
